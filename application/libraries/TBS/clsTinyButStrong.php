...
define('OPENTBS_PLUGIN','TBS\\clsOpenTBS');
...
define('OPENTBS_INFO','TBS\\clsOpenTBS.Info');       // command to display the archive info
define('OPENTBS_RESET','TBS\\clsOpenTBS.Reset');      // command to reset the changes in the current archive
define('OPENTBS_ADDFILE','TBS\\clsOpenTBS.AddFile');    // command to add a new file in the archive
define('OPENTBS_DELETEFILE','TBS\\clsOpenTBS.DeleteFile'); // command to delete a file in the archive
define('OPENTBS_REPLACEFILE','TBS\\clsOpenTBS.ReplaceFile'); // command to replace a file in the archive
define('OPENTBS_FILEEXISTS','TBS\\clsOpenTBS.FileExists');
define('OPENTBS_CHART','TBS\\clsOpenTBS.Chart'); // command to delete a file in the archive
define('OPENTBS_DEFAULT','');   // Charset
define('OPENTBS_ALREADY_XML',false);
define('OPENTBS_ALREADY_UTF8','already_utf8');
define('OPENTBS_DEBUG_XML_SHOW','TBS\\clsOpenTBS.DebugXmlShow');
define('OPENTBS_DEBUG_XML_CURRENT','TBS\\clsOpenTBS.DebugXmlCurrent');
define('OPENTBS_DEBUG_INFO','TBS\\clsOpenTBS.DebugInfo');
define('OPENTBS_DEBUG_CHART_LIST','TBS\\clsOpenTBS.DebugInfo'); // deprecated
define('OPENTBS_FORCE_DOCTYPE','TBS\\clsOpenTBS.ForceDocType');
define('OPENTBS_DELETE_ELEMENTS','TBS\\clsOpenTBS.DeleteElements');
define('OPENTBS_SELECT_SHEET','TBS\\clsOpenTBS.SelectSheet');
define('OPENTBS_SELECT_MAIN','TBS\\clsOpenTBS.SelectMain');
define('OPENTBS_DISPLAY_SHEETS','TBS\\clsOpenTBS.DisplaySheets');
define('OPENTBS_DELETE_SHEETS','TBS\\clsOpenTBS.DeleteSheets');
define('OPENTBS_DELETE_COMMENTS','TBS\\clsOpenTBS.DeleteComments');
